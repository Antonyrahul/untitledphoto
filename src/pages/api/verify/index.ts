        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; max-width: 600px; background-color: #FFF9ED;" role="presentation">
          <tr>
            <td align="center" style="padding: 40px 0 30px 0;">
              // <img src="/favicon.png" alt="SUPERRSHOTS" width="150" style="display: block; width: 150px; max-width: 150px; min-width: 150px; font-family: Arial, sans-serif; color: #333333; font-size: 18px;" border="0">
